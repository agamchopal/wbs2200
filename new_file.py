        ...
        if st.sidebar.button('Show Analysis'):
            ...
            if selected == "Contribution":
                ...
                if selected_user == 'Overall':
                    ...
                    fig
                    #    with col3:
                    st.markdown("<h3 style='text-align: center; color: red;'>Most Negitive Users</h3>",
                                unsafe_allow_html=True)
                    af = df['user'][df['value'] == -1]
                    x = af.value_counts()
                    fig = px.bar(af, y=x.values, x=x.index, color=x)
        ...
        try:
            ...
            if uploaded_file is not None:
                ...
                with col2:
                    ...
                    fig = px.pie(af12, values='percentage', names='sentiment',color_discrete_sequence=[ '#4d79ff', '#ff1a1a', '#33cc33'])#neutral,negative,positive
                    fig.update_traces(textposition='inside', textinfo='percent')
                    fig.update_layout(width=350, height=350)
                    fig
                ...
                with col1:
                    ...
                    fig = px.line(timeline, x='day_name', y='message', title='',
                                  width=350, height=400)
